...
class OAuthApi():
    ...
    def addBookmark(self, url, favorite=0, archive=0, options={}):
        ...
        return self.ApiCall('bookmarks', 'POST', options)

    def getBookmarks(self, options={}):
        return self.ApiCall('bookmarks', 'GET', options)
    ...
    def ApiCall(self, call, type="GET", parameters={}):
       ...
       Args:
        ...
        '''
        json = self._FetchUrl("https://www.readability.com/api/rest/v1/" + call, type, parameters)
